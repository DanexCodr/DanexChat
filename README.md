...
2. **Inference engine initialization**
    ...
    - A bundled factual dictionary (`assets/smollm2/dictionary.json`) is loaded at startup and injected into prompts as local grounding hints.
...
> **Note**: This project expects `app/src/main/assets/smollm2/model_q4.onnx`, `tokenizer.json`, and `dictionary.json` to be present when building.
